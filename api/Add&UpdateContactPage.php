...
if ($method === 'POST') {
    ...
    // 獲取前端数据
    $BannerTitle = isset($_POST['BannerTitle']) ? $_POST['BannerTitle'] : null;
    ...
    if (isset($_FILES['image']['name']) && $_FILES['image']['name'] != "") {
        ...
        $des_path = "../src/assets/contact/" . $image_name;
        ...
        if($current_image !=""){
            $remove_path = "../src/assets/contact/" . $current_image;
    ...
    if ($count > 0){
        ...
        $sql3 = "UPDATE tbl_contact_page SET
    ...
    //不然就執行創建
        ...
        $sql2 = "INSERT INTO tbl_contact_page SET
        banner_title = '$BannerTitle',
        title = '$Title',
        image_name      = '$image_name'
        ";
